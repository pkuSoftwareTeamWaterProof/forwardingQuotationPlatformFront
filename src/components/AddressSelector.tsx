...
import {apiURL, request} from "@/config";

export function AddressSelector({requestInfo, setRequestInfo, start}: {
    requestInfo: request,
            ...
            <div className="col-span-full grid grid-cols-4 gap-4">
                <SelectField
                    ...
                    onChange={async (e) => {
                        ...
                        setCurStateList(
                            await fetch(apiURL+'/api/getAddress', {
                                method: "POST",
                                mode: "no-cors",
                                headers: {
                                    "accept": "*/*",
