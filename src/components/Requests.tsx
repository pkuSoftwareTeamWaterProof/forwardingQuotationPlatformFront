            ...
            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              <thead>
                <tr>
                  ...
                  <th scope="col" className="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase">最高报价</th>
                  ...
                  Array.from(requests).map((request: sheet) => {
                    ...
                    return (
                      <tr key={request.createdAt}>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">{answer? answer.sort((a, b) => b.price - a.price)[0].price: 0}</td>
